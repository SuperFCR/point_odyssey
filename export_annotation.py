...
if __name__ == '__main__':
    ...
    if args.rendering:
        rendering_script = './blender-3.2.2-linux-x64/blender --background --python {}/render_single.py \
    ...
    if args.export_obj:
        obj_script = './blender-3.2.2-linux-x64/blender --background --python {}/utils/export_scene.py \
